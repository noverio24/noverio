        ...
        <div class="row">
            ...
            <div class="container admin-content">
                <div class="col s12 m12 l9 offset-l3">
                    <div class="hero-title">List of all Customers</div>
                    ...
                    <div class="admin-content">
                        ...
                        <div class="col s12 m12 l4">
                            <div class="card">
                                <div class="card-content">
                                    <p><b>Please insert Customer ID</b></p>
                                    <br>
                                    <form action="../customerDeleteHandler" method="post">
                                    <input type="number" placeholder="ADD 20 and then type 1 or 2 like 201" name="custID">
                                    <br>
