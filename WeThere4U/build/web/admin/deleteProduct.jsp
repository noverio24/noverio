                ...
                <div class="col s12 m12 l9 offset-l3">
                    ...
                    <div class="admin-content">
                        ...
                        <div class="col s12 m12 l4">
                            <div class="card">
                                <div class="card-content">
                                    <p><b>Please insert Product ID</b></p>
                                    <br>
                                    <form action="../productDeleteHandler" method="post">
                                    <input type="number" placeholder="ADD 900 and then type 1 or 2 like 9001" name="prdID">
                                    <br>
