                	...
                	<div class="login-page-content">
                		<div class="login-form">
							...
							<form action="welcome.php" method="post">
								...
								<div class="log-btn">
									<button type="submit" name="loginSubmit"><i class="fa fa-sign-in"></i> Log In</button>
								</div>
							</form>
                		</div>
                		...
                		<div class="create-ac">
                            <p>Forgot Password? <a href="Forget.php"> Reset Password</a></p>
        ...
        <div class="footer-widget-area">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Single Footer Widget Start -->
                    <div class="col-lg-4 col-md-6">/,
                        <div class="single-footer-wid-get">
                            <h2>get touch</h2>
                            <div class="widget-body">
                                ...
                                <ul class="get-touch">
                                    ...
                                    <li><i class="fa fa-mobile"></i> +880123456789</li>
                                    <li><i class="fa fa-envelope"></i> nazmussakib@gmail.com</li>
                                </ul>
		...
		include ('dbconnect.php');
						if(isset($_SESSION["Login"]))
						{
							if($_SESSION["Login"]=="Error" ){
								echo "<table> <tr> <td>INCORRECT USERNAME/PASSWORD. </tr> </table>" ;
							}
						}
						session_destroy();
						?>
