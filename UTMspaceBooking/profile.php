...
<div class="container-fluid"id="primary"><!--Primary Id-->
  <center><h1 style="background-color:#f9c61b;border-radius:0px;font-family: 'Baloo Bhai', cursive;box-shadow:5px 5px 9px black;text-shadow:2px 2px#000;display:inline-block;">User Profile</h1></center><br>
  <div class="container">
    <div class="row">
