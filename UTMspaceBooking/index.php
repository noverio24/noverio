...
<div class="container text-center">
  <h1>Welcome To <font color="YELLOW"><b>UTM SPACE BOOKING</b></font></h1><hr><br>
  <div class="row">
	...
	<div class="col-sm-4">
      ...
      <p class="text-justify"><?php echo substr($r_res['details'],0,100); ?></p><br>
	    <a href="room_details.php?room_id=<?php echo $r_res['hall_id']; ?>" class="btn btn-danger text-center">Read more</a><br><br>
    </div>
	<?php } ?>
  </div>
  </div>
